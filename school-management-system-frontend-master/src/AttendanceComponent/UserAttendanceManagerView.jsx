...
const UserAttendanceManagerView = () => {
  ...
  const retrieveEmployeeCurrentMonthAttendanceEntries = async () => {
    const response = await axios.get(
      `${BASE_URL}/api/attendance/fetch/user/current-month?userId=${userId}`
    );
  ...
  const regularizeAttendance = (e) => {
    ...
    const data = {
      updatedByUserId: teacher ? teacher.id : admin.id,
      userId: userId,
      date: regularizeDate,
    ...
    fetch(`${BASE_URL}/api/attendance/user/regularize`, {
      method: "POST",
      headers: {
...
export default UserAttendanceManagerView;
