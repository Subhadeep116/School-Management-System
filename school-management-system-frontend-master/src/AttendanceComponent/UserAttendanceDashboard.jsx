...
const UserAttendanceDashboard = () => {
  ...
  const todaysDate = new Date().toLocaleDateString("en-CA"); // Define today's date
  ...
  const retrieveEmployeeCurrentMonthAttendanceEntries = async () => {
    const response = await axios.get(
      `${BASE_URL}/api/attendance/fetch/user/current-month?userId=${
        teacher ? teacher.id : student.id
      }`
    );
  ...
  const clockIn = (e) => {
    ...
    fetch(
      `${BASE_URL}/api/attendance/user/clock-in?userId=${
        teacher ? teacher.id : student.id
      }`,
      {
        method: "GET",
  ...
  const clockOut = (e) => {
    ...
    fetch(
      `${BASE_URL}/api/attendance/user/clock-out?userId=${
        teacher ? teacher.id : student.id
      }`,
      {
        method: "GET",
  ...
  const requestForLeave = (e) => {
    ...
    const data = {
      userId: teacher ? teacher.id : student.id,
      date: leaveDate,
      reason: reason,
    };
                        ...
                        <b
                          style={{
                            color:
                              ...
                              attendance.status === "Half Day Present"
                                ? "red"
                                : "inherit",
                          }}
                        >
