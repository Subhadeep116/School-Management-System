...
const ManagerUsersLeaveManagement = () => {
  ...
  const retrieveAllLeaveRequests = async () => {
    const response = await axios.get(
      `${BASE_URL}/api/leave/request/manager/${teacher ? teacher.id : admin.id}`
    );
    ...
    <div className="mt-3">
                    ...
                    <tr>
                      ...
                      {teacher && (
                        <th scope="col">
                          <td>
                            <b>
                              {leaveRequest.user.batch.grade.name +
                                " [" +
                                leaveRequest.user.batch.name +
                                "]"}
                            </b>
                          </td>
                        </th>
      ...
      <Modal show={showModal} onHide={handleClose} size="md">
        <Modal.Header closeButton className="bg-color custom-bg-text">
          ...
          >
            User Leave Request Action Form!!!
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <div className="mt-3">
...
export default ManagerUsersLeaveManagement;
